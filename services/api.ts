export const TMBD_CONFIG = {
    ...
    API_KEY: process.env.EXPO_TMBD_API_KEY,
    headers:{
        accept:'application/json',
        Authorization: `Bearer ${process.env.EXPO_TMBD_API_KEY}`
    }
}
...
export const fetchMoviesDetails = async (movieId:string) : Promise<MoviesDetails> =>{
   try{
